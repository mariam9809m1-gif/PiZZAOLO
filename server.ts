...
const MENU_PRESETS: PresetPizza[] = [
  {
    ...
    description: 'Fresh crushed Pomodoro tomatoes, premium buffalo mozzarella, fresh basil leaves, and a drizzle of organic extra virgin olive oil.',
    category: 'Classic',
    basePrice: 11.99,
    ...
    defaultSauce: 'Marinara',
    defaultToppings: ['t_mozzarella']
  },
  {
    id: '2',
    name: 'Diavola Pepperoni',
    description: 'Spicy Naples-style pepperoni, cured salami, sliced jalapeños, shredded mozzarella, and our fiery marinara base.',
    category: 'Premium',
    basePrice: 14.99,
    image: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?auto=format&fit=crop&q=80&w=600',
    defaultSize: 'Medium',
    defaultCrust: 'Neapolitan',
    defaultSauce: 'Spicy Tomato',
    defaultToppings: ['t_mozzarella', 't_pepperoni', 't_jalapenos']
  },
  {
    id: '3',
    name: 'Garden Vegan Harvest',
    description: 'House vegan almond milk cheese, roasted red peppers, wild artichokes, mushrooms, baby spinach, and red bell peppers with a white garlic cream sauce.',
    category: 'Vegan',
    basePrice: 13.99,
    image: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&q=80&w=600',
    defaultSize: 'Medium',
    defaultCrust: 'Gluten-Free',
    defaultSauce: 'White Garlic Cream',
    defaultToppings: ['t_vegan_cheese', 't_bell_peppers', 't_spinach', 't_mushrooms']
  },
  {
    id: '4',
    name: 'Tuscan Pesto & Goat Cheese',
    description: 'Fragrant Genovese basil pesto, soft goat cheese crumbles, toasted pine nuts, whole sundried tomatoes, and fresh baby arugula.',
    category: 'Vegetarian',
    basePrice: 15.99,
...
const TOPPINGS_CATALOG: Topping[] = [
  ...
  { id: 't_gorgonzola', name: 'Gorgozola Blue', category: 'cheese', price: 1.50 },
